...
- Applied EN 18031 (EU RED cybersecurity) to a connected product: asset
  identification, decision-tree assessment, and evidence for third-party
  certification; tracking CRA readiness.
...
- Setup dockerized Jenkins with manual and GitOps centric builds, using Gitflow
  with automated build and deployment of releases.
